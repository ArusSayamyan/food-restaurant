//COMPONEnTS
// import ReservationModal from "./modal/ReservationModal.component"
// import { setModalState } from "src/redux/actions";
    ...
    <div>
      ...
      <div className={styles.main_content}>
        ...
        <div className={styles.buttons}>
          <button className={styles.tableButton} onClick={toggleModal}>
            Table Reservations
          </button>
